...
var (
	// IEnumGUID interface identifier 0002e000-0000-0000-c000-000000000046
	IEnumGUIDIID = &dcom.IID{Data1: 0x0002e000, Data2: 0x0000, Data3: 0x0000, Data4: []byte{0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	// Syntax UUID
	IEnumGUIDSyntaxUUID = &uuid.UUID{TimeLow: 0x2e000, TimeMid: 0x0, TimeHiAndVersion: 0x0, ClockSeqHiAndReserved: 0xc0, ClockSeqLow: 0x0, Node: [6]uint8{0x0, 0x0, 0x0, 0x0, 0x0, 0x46}}
	// Syntax ID
	IEnumGUIDSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: IEnumGUIDSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IEnumGUID interface.
type IEnumGUIDClient interface {
	...
	IPID(context.Context, *dcom.IPID) IEnumGUIDClient
}

type xxx_DefaultIEnumGUIDClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultIEnumGUIDClient) Unknown() iunknown.UnknownClient {
	return o.UnknownClient
}

func (o *xxx_DefaultIEnumGUIDClient) Next(ctx context.Context, in *NextRequest, opts ...dcerpc.CallOption) (*NextResponse, error) {
...
func (o *xxx_DefaultIEnumGUIDClient) Skip(ctx context.Context, in *SkipRequest, opts ...dcerpc.CallOption) (*SkipResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultIEnumGUIDClient) Reset(ctx context.Context, in *ResetRequest, opts ...dcerpc.CallOption) (*ResetResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultIEnumGUIDClient) Clone(ctx context.Context, in *CloneRequest, opts ...dcerpc.CallOption) (*CloneResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultIEnumGUIDClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultIEnumGUIDClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultIEnumGUIDClient) IPID(ctx context.Context, ipid *dcom.IPID) IEnumGUIDClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultIEnumGUIDClient{
...
func NewIEnumGUIDClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (IEnumGUIDClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(IEnumGUIDSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
type xxx_NextOperation struct {
	...
	Elements []*dtyp.GUID   `idl:"name:rgelt;size_is:(celt);length_is:(pceltFetched)" json:"elements"`
...
func (o *xxx_NextOperation) OpName() string { return "/IEnumGUID/v0/Next" }
...
func (o *xxx_NextOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// rgelt {out} (1:{pointer=ref}*(1))(2:{alias=GUID}[dim:0,size_is=celt,length_is=pceltFetched](struct))
	{
...
func (o *xxx_NextOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// rgelt {out} (1:{pointer=ref}*(1))(2:{alias=GUID}[dim:0,size_is=celt,length_is=pceltFetched](struct))
	{
		...
		o.Elements = make([]*dtyp.GUID, sizeInfo[0])
		for i1 := range o.Elements {
			i1 := i1
			if o.Elements[i1] == nil {
				o.Elements[i1] = &dtyp.GUID{}
			}
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IEnumGUID/v0/Next" }
...
func (o *xxx_SkipOperation) OpName() string { return "/IEnumGUID/v0/Skip" }
...
// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IEnumGUID/v0/Skip" }
...
func (o *xxx_ResetOperation) OpName() string { return "/IEnumGUID/v0/Reset" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IEnumGUID/v0/Reset" }
...
type xxx_CloneOperation struct {
	This   *dcom.ORPCThis    `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat    `idl:"name:That" json:"that"`
	Enum   *comcat.IEnumGUID `idl:"name:ppenum" json:"enum"`
	Return int32             `idl:"name:Return" json:"return"`
}
...
func (o *xxx_CloneOperation) OpName() string { return "/IEnumGUID/v0/Clone" }
...
func (o *xxx_CloneOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// ppenum {out} (1:{pointer=ref}*(2)*(1))(2:{alias=IEnumGUID}(interface))
	{
		if o.Enum != nil {
...
func (o *xxx_CloneOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// ppenum {out} (1:{pointer=ref}*(2)*(1))(2:{alias=IEnumGUID}(interface))
	{
		...
		_s_ppenum := func(ptr interface{}) { o.Enum = *ptr.(**comcat.IEnumGUID) }
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IEnumGUID/v0/Clone" }
