...
var (
	// IEnumCATEGORYINFO interface identifier 0002e011-0000-0000-c000-000000000046
	IEnumCategoryInformationIID = &dcom.IID{Data1: 0x0002e011, Data2: 0x0000, Data3: 0x0000, Data4: []byte{0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	// Syntax UUID
	IEnumCategoryInformationSyntaxUUID = &uuid.UUID{TimeLow: 0x2e011, TimeMid: 0x0, TimeHiAndVersion: 0x0, ClockSeqHiAndReserved: 0xc0, ClockSeqLow: 0x0, Node: [6]uint8{0x0, 0x0, 0x0, 0x0, 0x0, 0x46}}
	// Syntax ID
	IEnumCategoryInformationSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: IEnumCategoryInformationSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IEnumCATEGORYINFO interface.
type IEnumCategoryInformationClient interface {
	...
	IPID(context.Context, *dcom.IPID) IEnumCategoryInformationClient
}

// CategoryInformation structure represents CATEGORYINFO RPC structure.
type CategoryInformation struct {
	CategoryID  *comcat.CategoryID `idl:"name:catid" json:"category_id"`
	LCID        uint32             `idl:"name:lcid" json:"lcid"`
	Description []uint16           `idl:"name:szDescription" json:"description"`
}

func (o *CategoryInformation) xxx_PreparePayload(ctx context.Context) error {
...
func (o *CategoryInformation) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	...
	for i1 := len(o.Description); uint64(i1) < 128; i1++ {
...
func (o *CategoryInformation) UnmarshalNDR(ctx context.Context, w ndr.Reader) error {
	if err := w.ReadAlign(4); err != nil {
		return err
	}
	if o.CategoryID == nil {
		o.CategoryID = &comcat.CategoryID{}
	}
...
type xxx_DefaultIEnumCategoryInformationClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultIEnumCategoryInformationClient) Unknown() iunknown.UnknownClient {
	return o.UnknownClient
}

func (o *xxx_DefaultIEnumCategoryInformationClient) Next(ctx context.Context, in *NextRequest, opts ...dcerpc.CallOption) (*NextResponse, error) {
...
func (o *xxx_DefaultIEnumCategoryInformationClient) Skip(ctx context.Context, in *SkipRequest, opts ...dcerpc.CallOption) (*SkipResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultIEnumCategoryInformationClient) Reset(ctx context.Context, in *ResetRequest, opts ...dcerpc.CallOption) (*ResetResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultIEnumCategoryInformationClient) Clone(ctx context.Context, in *CloneRequest, opts ...dcerpc.CallOption) (*CloneResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultIEnumCategoryInformationClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultIEnumCategoryInformationClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultIEnumCategoryInformationClient) IPID(ctx context.Context, ipid *dcom.IPID) IEnumCategoryInformationClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultIEnumCategoryInformationClient{
...
func NewIEnumCategoryInformationClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (IEnumCategoryInformationClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(IEnumCategoryInformationSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
type xxx_NextOperation struct {
	...
	Elements []*CategoryInformation `idl:"name:rgelt;size_is:(celt);length_is:(pceltFetched)" json:"elements"`
...
func (o *xxx_NextOperation) OpName() string { return "/IEnumCATEGORYINFO/v0/Next" }
...
func (o *xxx_NextOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if o.Elements != nil && o.Fetched == 0 {
		o.Fetched = uint32(len(o.Elements))
	}
...
func (o *xxx_NextOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// rgelt {out} (1:{pointer=ref}*(1))(2:{alias=CATEGORYINFO}[dim:0,size_is=celt,length_is=pceltFetched](struct))
	{
		...
		for i1 := range o.Elements {
			...
			if o.Elements[i1] != nil {
				...
				if err := (&CategoryInformation{}).MarshalNDR(ctx, w); err != nil {
					return err
				}
			}
		}
...
func (o *xxx_NextOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// rgelt {out} (1:{pointer=ref}*(1))(2:{alias=CATEGORYINFO}[dim:0,size_is=celt,length_is=pceltFetched](struct))
	{
		...
		o.Elements = make([]*CategoryInformation, sizeInfo[0])
		for i1 := range o.Elements {
			i1 := i1
			if o.Elements[i1] == nil {
				o.Elements[i1] = &CategoryInformation{}
			}
...
// OpName returns the operation name of Next operation.
func (o *NextRequest) OpName() string { return "/IEnumCATEGORYINFO/v0/Next" }
...
func (o *xxx_SkipOperation) OpName() string { return "/IEnumCATEGORYINFO/v0/Skip" }
...
// OpName returns the operation name of Skip operation.
func (o *SkipRequest) OpName() string { return "/IEnumCATEGORYINFO/v0/Skip" }
...
func (o *xxx_ResetOperation) OpName() string { return "/IEnumCATEGORYINFO/v0/Reset" }
...
// OpName returns the operation name of Reset operation.
func (o *ResetRequest) OpName() string { return "/IEnumCATEGORYINFO/v0/Reset" }
...
type xxx_CloneOperation struct {
	This   *dcom.ORPCThis                   `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat                   `idl:"name:That" json:"that"`
	Enum   *comcat.IEnumCategoryInformation `idl:"name:ppenum" json:"enum"`
	Return int32                            `idl:"name:Return" json:"return"`
}
...
func (o *xxx_CloneOperation) OpName() string { return "/IEnumCATEGORYINFO/v0/Clone" }
...
func (o *xxx_CloneOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// ppenum {out} (1:{pointer=ref}*(2)*(1))(2:{alias=IEnumCATEGORYINFO}(interface))
	{
		if o.Enum != nil {
...
func (o *xxx_CloneOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// ppenum {out} (1:{pointer=ref}*(2)*(1))(2:{alias=IEnumCATEGORYINFO}(interface))
	{
		_ptr_ppenum := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.Enum == nil {
				o.Enum = &comcat.IEnumCategoryInformation{}
			}
		...
		_s_ppenum := func(ptr interface{}) { o.Enum = *ptr.(**comcat.IEnumCategoryInformation) }
...
// OpName returns the operation name of Clone operation.
func (o *CloneRequest) OpName() string { return "/IEnumCATEGORYINFO/v0/Clone" }
